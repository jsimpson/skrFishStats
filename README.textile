...
Right now, it only has both a live display for the current zone/subzone that you are fishing in and the ability to browse stats by zone/subzone. The display will be toggled automatically when equipping fishing gear, from actively fishing, or via the command:
    * /skrfs
